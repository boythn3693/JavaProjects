...
public class ProductModel {
    ...
    public List runQueryProduct() {
        final String QUERY_PRODUCT = "from Product p JOIN FETCH p.category c";
    ...
    public List<Product> getAllDataProduct() {
        final String QUERY_GET_ALL_PRODUCT = "from Product p JOIN FETCH p.category c order by p.productId desc";
...
//    }
    public List<Product> getListProduct(int status) {
        final String QUERY_GET_ALL_PRODUCT = "from Product p JOIN FETCH p.category c where status = %d order by productId desc";
...
//            where += (where.equals("") == true) ? "where p.productType like '%"+filter+"%' " : "or p.productType like '%"+filter+"%' ";
//        }
        final String QUERY_GET_PRODUCT = "from Product p JOIN FETCH p.category c " + where;
    ...
    public List<Product> getDataProductFilter2(long productType, int status) {
        ...
        final String QUERY_GET_PRODUCT = "from Product JOIN FETCH p.category c " + where;
